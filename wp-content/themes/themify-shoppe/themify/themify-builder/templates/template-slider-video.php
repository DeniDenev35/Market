...
if (!empty($settings['video_content_slider'])):?>
	<?php $total_items = count( $settings['video_content_slider'] ); ?>
	
    <?php foreach ($settings['video_content_slider'] as $index => $video): ?>
        <?php if ( $index % $settings['items_per_slide'] === 0 ) : ?><div class="tf_swiper-slide"><?php endif; ?>
        ...
        <?php if ( ( $index + 1 ) % $settings['items_per_slide'] === 0 || ( $index + 1 ) === $total_items ) : ?></div><!-- .tf_swiper-slide --><?php endif; ?>
